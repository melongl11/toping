...
// 로그아웃시
        $("nav#dropdown").meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='/'><img src='../../img/logo.png' alt='logo' class='img-fluid'/></a><div class='btn_login'><a href='/users/login'>로그인</a></div></div>"
        });


// 로그인시
        // $("nav#dropdown").meanmenu({
        //     siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='/'><img src='../../img/logo.png' alt='logo' class='img-fluid'/></a><span style='text-align:right; width:50%;'><a href='/users/login' class='bt_login'>로그아웃</a></span></div>"
        // });
    ...
    if ($container.length > 0) {
        ...
        console.log(test.attr("data-filter"));
        var blogGallerIso = $(".featuredContainer", $container).imagesLoaded(function () {
            $isotope = $(".featuredContainer", $container).isotope({
                filter: test.attr("data-filter"),
